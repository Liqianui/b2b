				...
				<el-table-column label="操作" width="300">
					<template #default="scope">
						<el-button size="large" type="primary"  link
							@click="handleStatus(postUpShelf, scope.row.id)">取消订单</el-button>
							<el-button size="large" type="primary"  link
								@click="handleStatus(postUpShelf, scope.row.id)">发货</el-button>
								<el-button size="large" type="primary"  link
									@click="handleStatus(postUpShelf, scope.row.id)">结单</el-button>
